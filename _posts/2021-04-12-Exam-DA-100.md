...
* **Separate date and time, if bound together.** If any of the tables have columns that combine date and time, make sure they are separated into distinct columns before importing them into Power BI. This approach will increase compression abilities.
